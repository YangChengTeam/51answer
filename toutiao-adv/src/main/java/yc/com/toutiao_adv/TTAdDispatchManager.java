...
public class TTAdDispatchManager {
    ...
    public void init(Activity activity, TTAdType adType, ViewGroup container, String adId, int nativeCount, List<Integer> positions,
        ...
        if (adType == TTAdType.SPLASH) {
            ...
            managerListener = new NativeAdManager(activity, adId, nativeCount,positions, onAdvStateListener);

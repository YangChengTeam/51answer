 ...
 * @author vondear
 */
public class ActivityScanerCodeNew extends ActivityBase {
...
//    private CaptureActivityHandler handler;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_normal_capture);
...
//        mIvLight = findViewById(R.id.top_mask);
        ...
        mCropLayout = findViewById(R.id.capture_crop_view);
        mLight = findViewById(R.id.light_lay);
        offDrawable = getResources().getDrawable(R.drawable.icon_lamp_off);
        onDrawable = getResources().getDrawable(R.drawable.icon_lamp_on);
//        mLlScanHelp = findViewById(R.id.ll_scan_help);
    ...
    private void initScanerAnimation() {
        ...
        TranslateAnimation translateAnimation = new TranslateAnimation(0, 0, 0, 400f);
        translateAnimation.setRepeatCount(-1);
        translateAnimation.setRepeatMode(Animation.RESTART);
        translateAnimation.setInterpolator(new LinearInterpolator());
        translateAnimation.setDuration(4000);
        mQrLineView.startAnimation(translateAnimation);
    ...
    public void btn(View view) {
        ...
        if (viewId == R.id.light_lay) {
            light();
        } else if (viewId == R.id.top_back) {
            finish();
        } else if (viewId == R.id.tv_select_photo) {
            RxPhotoTool.openLocalImage(mContext);
        } else if (viewId == R.id.input_barcode_tv) {
    ...
    private void light() {
        if (mFlashing) {
            ...
            onDrawable.setBounds(0, 0, onDrawable.getMinimumWidth(), onDrawable.getMinimumHeight());

            mLight.setCompoundDrawables(onDrawable, null, null, null);
            mLight.setTextColor(ContextCompat.getColor(this, R.color.color_ee4545));
        } else {
            mFlashing = true;
            // 关闪光灯
            CameraManager.get().offLight();
            offDrawable.setBounds(0, 0, offDrawable.getMinimumWidth(), offDrawable.getMinimumHeight());

            mLight.setCompoundDrawables(offDrawable, null, null, null);
            mLight.setTextColor(ContextCompat.getColor(this, R.color.color_white));
        }
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        if (handler == null) {
            handler = new CaptureActivityHandler(ActivityScanerCodeNew.this);

...
public class BrowserActivity extends BaseActivity<BrowserPresenter> implements BroswerContract.View {
    ...
    private void initListener() {
        ...
        browserAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            @Override
        ...
        browserAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            @Override
        ...
        browserAdapter.setOnLoadMoreListener(new BaseQuickAdapter.RequestLoadMoreListener() {
            @Override
...
//        smartRefreshLayout.autoRefresh();
    ...
    public void showNoNet() {
        stateView.showNoNet(smartRefreshLayout, HttpConfig.NET_ERROR, new View.OnClickListener() {
            @Override

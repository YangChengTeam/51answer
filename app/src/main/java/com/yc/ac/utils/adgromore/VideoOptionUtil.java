...
public class VideoOptionUtil {
    ...
    public static TTVideoOption getTTVideoOption() {
        ...
        BaiduExtraOptions baiduExtraOptions = new BaiduExtraOptions.Builder()
                .setGDTExtraOption(BaiduExtraOptions.DOWNLOAD_APP_CONFIRM_ALWAYS) // 设置下载提示弹框的展示规则, 默认不提示
                .setShowDialogOnSkip(true) // 设置点击跳过时是否展示提示弹框
    ...
    public static GDTExtraOption getTTVideoOption3() {
        //广点通（GDT）单独使用配置
        GDTExtraOption gdtExtraOption = new GDTExtraOption.Builder()
    ...
    public static TTVideoOption getSplashProLoadTTVideoOption() {
        //广点通（GDT）单独使用配置
        GDTExtraOption gdtExtraOption = new GDTExtraOption.Builder()

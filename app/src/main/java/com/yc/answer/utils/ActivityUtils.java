...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String packageName, @NonNull final String className) {
        ...
        return !(RxTool.getContext().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(RxTool.getContext().getPackageManager()) == null ||
                RxTool.getContext().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void startActivity(@NonNull final String pkg, @NonNull final String cls) {
        startActivity(RxTool.getContext(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
        ...
        startActivity(RxTool.getContext(), extras, pkg, cls, extras);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls,
                                     @NonNull final Bundle options) {
        startActivity(RxTool.getContext(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     ...
                                     @NonNull final String cls,
                                     @NonNull final Bundle options) {
        startActivity(RxTool.getContext(), extras, pkg, cls, options);
    }
    ...
    public static String getLauncherActivity(@NonNull final String packageName) {
        ...
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        PackageManager pm = RxTool.getContext().getPackageManager();

...
public class PhotoView extends ImageView {
    ...
    public void setOnTouchImageViewListener(PhotoViewAttacher.OnTouchImageViewListener onTouchImageViewListener) {
        attacher.setOnTouchImageViewListener(onTouchImageViewListener);
    }
